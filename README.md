...
The tests can be run with the tests.sh script, which produces aCSV file consisting of misprediction rates of the different predictors on all of the files in the tests directory ending with ".out".
